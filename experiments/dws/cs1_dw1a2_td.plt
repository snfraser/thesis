...
set output "cs1_dw1a2_td.eps"
set term postscript enhanced color landscape lw 1

plot \
"cs1_dw1_td.dat" using 1:2 with point pt 5  ti "ENV = E_{FP}, SEL = BEST", \
3.29 lt 1 ti "ENV = E_{FP}, SEL = RAND", \
"cs1_dw2_td.dat" using 1:2 with point pt 6 ti "ENV = E_{FX}, SEL = BEST", \
3.37 lt 3 ti "ENV = E_{FX}, SEL = RAND"
