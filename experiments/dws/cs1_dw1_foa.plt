...
set label 1 "ENV = E_{FP}" at graph 0.1,0.2
#set label 2 "SEL = BEST"   at graph 0.1,0.2

set output "cs1_dw1_foa.eps"
set term postscript enhanced color landscape
plot "cs1_dw1_foa.dat" using 1:($2-$5):3:4:($2+$5) with candlestick lt 1 ti "SEL = BEST", 0.785 lt 3 ti "SEL = RAND"  
