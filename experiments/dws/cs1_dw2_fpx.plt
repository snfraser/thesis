...
set label 1 "ENV = E_{FX}" at graph 0.1,0.8
#set label 2 "SEL = BEST"   at graph 0.1,0.2

set output "cs1_dw2_fpx.eps"
set term postscript enhanced color landscape
plot "cs1_dw2_fpx.dat" using 1:($2-$5):3:4:($2+$5) with candlestick lt 1 ti "SEL = BEST",\
0.413 lt 3 ti "SEL = RAND"
