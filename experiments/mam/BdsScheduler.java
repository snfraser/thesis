...
public class BdsScheduler {
    ...
    public BdsScheduler(ConfigurationProperties cfg) throws Exception {
...
// 	return null;
	...
	if (candidates.size() != 0) {
	    ...
	    Agroup bestGroup = (Agroup)candidates.get(in);
	    return bestGroup;
	} 
	return null;
    }
	...
	return 0.8*metrics.scoreElev(group, t)+
	    0.2*metrics.scorePriority(group,t);
	...
	try {
	    ...
	    BdsScheduler bds = new BdsScheduler(cfg);
